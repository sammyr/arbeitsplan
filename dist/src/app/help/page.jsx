    ...
    return (<div className="container mx-auto px-4 py-8">
      <div className="flex flex-col items-center mb-12">
        <div className="relative w-[120px] h-[60px] mb-6">
          <image_1.default src="/images/logo.jpg" alt="Arbeitsplan Manager Logo" fill style={{ objectFit: 'contain' }} priority className="rounded-lg"/>
        </div>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <section>
          <h2 className="text-2xl font-semibold mb-6 text-slate-800 flex items-center">
            <span className="bg-emerald-100 p-2 rounded-lg mr-3">
              <hi2_1.HiLightBulb className="w-5 h-5 text-emerald-600"/>
            </span>
            Geplant
          </h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-6 text-slate-800 flex items-center">
            <span className="bg-emerald-100 p-2 rounded-lg mr-3">
              <hi2_1.HiClipboardDocument className="w-5 h-5 text-emerald-600"/>
            </span>
            Changelog
          </h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-6 text-slate-800 flex items-center">
            <span className="bg-emerald-100 p-2 rounded-lg mr-3">
              <hi2_1.HiChatBubbleLeftRight className="w-5 h-5 text-emerald-600"/>
            </span>
            Support
          </h2>
          <div className="bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-200 p-6 border border-slate-200">
              ...
              <div>
                ...
                <ul className="space-y-3 text-slate-600">
                  <li className="flex items-center">
                    <span className="bg-emerald-100 p-2 rounded-lg mr-3">
                      <hi2_1.HiBookOpen className="w-5 h-5 text-emerald-600"/>
                    </span>
                    Name: Silvia Kaspar
                  </li>
                  <li className="flex items-center">
                    <span className="bg-emerald-100 p-2 rounded-lg mr-3">
                      <hi2_1.HiEnvelope className="w-5 h-5 text-emerald-600"/>
                    </span>
                    E-Mail: <a href="mailto:sunny1366@web.de" className="text-emerald-600 hover:text-emerald-700 ml-1">sunny1366@web.de</a>
                  </li>
                  <li className="flex items-center">
                    <span className="bg-emerald-100 p-2 rounded-lg mr-3">
                      <hi2_1.HiPhone className="w-5 h-5 text-emerald-600"/>
                    </span>
